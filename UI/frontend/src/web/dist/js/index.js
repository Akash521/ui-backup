$(function(){
    function pageLoad(){
        ...
        if( $('#feed').length )         // use this if you are using id to check
        {
            $("#feed").slimscroll({
                height: '320',
                size: '5px',
        ...
        if( $('#feed3').length )         // use this if you are using id to check
        {
            $("#feed3").slimscroll({
                height: '210',
                size: '5px',
        ...
        if( $('#feed2').length )         // use this if you are using id to check
        {
            $("#feed2").slimscroll({
                height: '590px',
                size: '5px',
        ...
        if( $('#feedP1').length )         // use this if you are using id to check
        {
            // $("#feedP1").slimscroll({
            //     height: '671px',
            //     size: '5px',
        ...
        if( $('#feedP2').length )         // use this if you are using id to check
        {
            // $("#feedP2").slimscroll({
            //     height: '611px',
            //     size: '5px',
        ...
        if( $('#feedP3').length )         // use this if you are using id to check
        {
            // $("#feedP3").slimscroll({
            //     height: '611px',
            //     size: '5px',
        ...
        if( $('#feedP4').length )         // use this if you are using id to check
        {
            // $("#feedP4").slimscroll({
            //     height: '611px',
            //     size: '5px',
        ...
        if( $('#feed1').length )         // use this if you are using id to check
        {
            $("#feed1").slimscroll({
                height: '210px',
                size: '5px',
        ...
        if( $('#chat-messages').length )         // use this if you are using id to check
        {
