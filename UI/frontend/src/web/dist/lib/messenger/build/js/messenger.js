...
(function () {
  ...
  Events =
    (_ref1 =
      typeof Backbone !== "undefined" && Backbone !== null
        ? Backbone.Events
        : void 0) != null
      ? _ref1
  ...
  _Message = (function (_super) {
    ...
    _Message.prototype.actionsToEvents = function () {
      ...
      for (name in _ref2) {
        act = _ref2[name];
        _results.push(
          (this.events['click [data-action="' + name + '"] a'] = (function (
            act
          ) {
            return function (e) {
              e.preventDefault();
    ...
    _Message.prototype.undelegateEvents = function () {
      ...
      return (_ref2 = this.$message) != null
        ? _ref2.removeClass("messenger-clickable")
        : void 0;
    };
    ...
    _Message.prototype.template = function (opts) {
      var $action,
        ...
        _this = this;
      $message = $(
        "<div class='messenger-message message alert " +
          opts.type +
          " message-" +
          opts.type +
          " alert-" +
      ...
      if (opts.escapeText) {
        $text = $('<div class="messenger-message-inner"></div>').text(
          opts.message
        );
      } else {
        $text = $(
          '<div class="messenger-message-inner">' + opts.message + "</div>"
        );
      }
      $message.append($text);
  ...
  RetryingMessage = (function (_super) {
    ...
    RetryingMessage.prototype.clearTimers = function () {
      ...
      this._timers = {};
      return (_ref3 = this.$message) != null
        ? _ref3.removeClass("messenger-retry-soon messenger-retry-later")
        : void 0;
    };
    ...
    RetryingMessage.prototype.startCountdown = function (name, action) {
      ...
      $phrase = this.$message.find(
        "[data-action='" + name + "'] .messenger-phrase"
      );
      ...
      tick = function () {
        ...
        if (remaining > 0) {
          ...
          _this.$message.removeClass(
            "messenger-retry-soon messenger-retry-later"
          );
  ...
  _Messenger = (function (_super) {
    ...
    _Messenger.prototype._reserveMessageSlot = function (msg) {
      ...
      while (
        ...
        this.history.length > this.options.maxMessages
      ) {
    ...
    _Messenger.prototype._enforceIdConstraint = function (msg) {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        _msg = entry.msg;
        if (
          _msg.options.id != null &&
          _msg.options.id === msg.options.id &&
          msg !== _msg
        ) {
    ...
    _Messenger.prototype.newMessage = function (opts) {
      ...
      _Message =
        (_ref2 =
          (_ref3 =
            Messenger.themes[
              (_ref4 = opts.theme) != null ? _ref4 : this.options.theme
            ]) != null
            ? _ref3.Message
            : void 0) != null
          ? _ref2
    ...
    _Messenger.prototype.updateMessageSlotClasses = function () {
      ...
      return this.$el["" + (anyShown ? "remove" : "add") + "Class"](
        "messenger-empty"
      );
    };
  ...
  ActionMessenger = (function (_super) {
    ...
    ActionMessenger.prototype.hookBackboneAjax = function (msgr_opts) {
      ...
      if (Backbone.ajax != null) {
        ...
        if (
          !(msgr_opts.action != null) ||
          msgr_opts.action === this.doDefaults.action
        ) {
    ...
    ActionMessenger.prototype._normalizeResponse = function () {
      ...
      for (_i = 0, _len = resp.length; _i < _len; _i++) {
        ...
        if (elem === "success" || elem === "timeout" || elem === "abort") {
          ...
          (elem != null ? elem.readyState : void 0) != null &&
          (elem != null ? elem.responseText : void 0) != null
        ) {
          xhr = elem;
    ...
    ActionMessenger.prototype.run = function () {
      ...
      msg =
        (_ref2 = m_opts.messageInstance) != null
          ? _ref2
          : this.newMessage(m_opts);
      if (m_opts.id != null) {
      ...
      _.each(["error", "success"], function (type) {
        ...
        return (handlers[type] = function () {
          ...
          if (
            type === "success" &&
            !(msg.errorCount != null) &&
            m_opts.showSuccessWithoutError === false
          ) {
          ...
          handlerResp = m_opts.returnsPromise
            ? resp[0]
            : typeof originalHandler === "function"
            ? originalHandler.apply(null, resp)
            : void 0;
          ...
          if (
            type === "error" &&
            ((xhr != null ? xhr.status : void 0) === 0 || reason === "abort")
          ) {
            msg.hide();
            return;
          }
          if (
            type === "error" &&
            m_opts.ignoredErrorCodes != null &&
            ((_ref5 = xhr != null ? xhr.status : void 0),
          ...
          if (
            typeof ((_ref7 = msgOpts.retry) != null ? _ref7.allow : void 0) ===
            "number"
          ) {
            msgOpts.retry.allow--;
          }
          if (
            type === "error" &&
            (xhr != null ? xhr.status : void 0) >= 500 &&
            ((_ref8 = msgOpts.retry) != null ? _ref8.allow : void 0)
          ) {
              ...
              retry: {
                ...
                action: function () {
                  ...
                  return setTimeout(function () {
                    return _this["do"].apply(
                      _this,
                      [msgOpts, opts].concat(__slice.call(args))
                    );
                  }, 0);
                },
              },
      ...
      msg._actionInstance = m_opts.action.apply(
        m_opts,
        [opts].concat(__slice.call(args))
      );
      if (m_opts.returnsPromise) {
  ...
  $.fn.messenger = function () {
    ...
    if (!(func != null) || !_.isString(func)) {
      ...
      if (!($el.data("messenger") != null)) {
        _Messenger =
          (_ref2 =
            (_ref3 = Messenger.themes[opts.theme]) != null
              ? _ref3.Messenger
              : void 0) != null
            ? _ref2
            : ActionMessenger;
  ...
  window.Messenger._call = function (opts) {
    ...
    inst.$el.addClass(
      (classes = "" + inst.className + " " + opts.extraClasses)
    );
